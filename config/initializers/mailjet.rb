...
Mailjet.configure do |config|
  config.api_key = Rails.application.credentials[Rails.env.to_sym][:mailjet][:api_key]
  config.secret_key = Rails.application.credentials[Rails.env.to_sym][:mailjet][:secret_key]
  config.default_from = Rails.application.credentials[Rails.env.to_sym][:mailjet][:default_from]
